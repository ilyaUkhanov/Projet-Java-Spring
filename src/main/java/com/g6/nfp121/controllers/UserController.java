...
import com.g6.nfp121.repositories.UserRepository;
import com.g6.nfp121.security.AuthenticationFacade;
import com.g6.nfp121.security.JwtTokenProvider;
import com.g6.nfp121.entities.UserFactory;
...
import com.g6.nfp121.hateoas.UserModelAssembler;
import com.g6.nfp121.models.user.UserDeleteModel;
import com.g6.nfp121.models.user.UserResponseModel;
import com.g6.nfp121.models.user.UserSigninModel;
import com.g6.nfp121.models.user.UserSignupModel;
import com.g6.nfp121.models.user.UserStatisticsModel;
import com.g6.nfp121.models.user.UserUpdateModel;
import com.g6.nfp121.services.UserService;
...
public class UserController {
    ...
    public @ResponseBody ResponseEntity<UserResponseModel> getUserStatistics() throws ApiNoUserException {

        User user = authenticationFacade.getUser().orElseThrow(ApiNoUserException::new);
        UserResponseModel model = userService.convertToResponseModel(user);
